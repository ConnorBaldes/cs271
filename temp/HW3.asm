...
; CS271	AS3       2/25/2020
; Description:  This program displays the program title and your name. 
;Then asks the user for their name and greets the user. It then asks the user
; to choose between integer and floating point arithmetic. The user is then 
;prompted for 
